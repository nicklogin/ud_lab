...
from MorphValidator import UDFeatsSet
...
def validate_features(cols, tag_sets, args):
    ...
    feat_set.check_tagset(cols[UPOS], attr_values)
...
if __name__=="__main__":
    ...
    list_group.add_argument("--featsfile", action="store", default=None, help="The file with allowed features in UDFEATS format")
    ...
    if args.featsfile:
        feat_set = UDFeatsSet(args.featsfile, warn_func=warn)
